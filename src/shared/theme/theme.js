export const theme = {
  ...
  colors: {
    ...
    success: { 50: '#edf8f4', 100: '#d8f0e7', 200: '#aee0cc', 500: '#2E7D32', 600: '#2E7D32', 700: '#1e5322' },
    warning: { 50: '#fff8eb', 100: '#f8ead0', 200: '#efd19b', 500: '#F9A825', 600: '#F9A825', 700: '#8f5d18' },
    error: { 50: '#fff0ee', 100: '#f8d9d5', 200: '#efb6ae', 500: '#D32F2F', 600: '#D32F2F', 700: '#93000a' },
    balanceHero: {
      muted: '#d8e0e8',
      badge: '#355069',
      badgeText: '#eaf3fb',
